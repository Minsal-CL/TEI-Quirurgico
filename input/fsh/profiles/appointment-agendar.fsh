...
* basedOn 1..1 MS
* basedOn ^short = "Referencia a la orden de cirugía que generó esta cita"
* basedOn only Reference(ServiceRequestCirugiaLE)

* serviceType 1..1 MS
* serviceType ^short = "Identifica el tipo de servicio que corresponde a la cita. Puede ser Entrevista Pre Quirúrgica, o Agendamiento de quirófano"
* serviceType from VSTipoServicioAgendamiento

* appointmentType 0..1 MS
* appointmentType ^short = "Tipo de cita, puede ser \"Electiva Normal | Electiva Condicional\". Aplica solo para agendamiento de tabla"
* appointmentType from VSTipoAgendamiento
