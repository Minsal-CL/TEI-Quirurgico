...
* occurrenceDateTime ^short = "Fecha y hora en que se debería realizar el estudio. El formato corresponde a año, mes, día y hora (hh:mm) y se representa de la siguiente forma: YYYY-MM-DDTHH:MMZ"
...
* encounter 1..1 MS
* encounter ^short = "Encuentro en el cual se solicita el examen"
